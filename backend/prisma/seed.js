// prisma/seed.ts
import { PrismaClient, Role, JobRole, JobType, FieldType, ApplicationStatus, } from '@prisma/client';
    ...
    if (job1 && seeker) {
        ...
        if (!existingApp1) {
            ...
            for (const field of job1Fields) {
                ...
                if (field.fieldType === FieldType.RESUME_URL)
                    answer = '/resumes/alice.pdf';
